    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="modalUserForm" class="row g-6" action="{{ route('event.store') }}" method="POST"
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" id="location" autocomplete="off" name="location"
                            value="{{ old('location') }}" class="form-control" placeholder="Lokasi Event" />
                    </div>

                    <!-- Quota -->
                    <div class="col-12 col-md-2">
                        <label class="form-label" for="location">Kuota</label>
                        <input type="number" id="quota" autocomplete="off" name="quota" value="{{ old('quota') }}"
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" id="start_date" autocomplete="off" name="start_date"
                            value="{{ old('start_date') }}" class="form-control flatpickr-datetime" />
                    </div>

                    <!-- Tanggal Selesai -->
                    <div class="col-12 col-md-6">
                        <label class="form-label" for="end_date">Tanggal Selesai</label>
                        <input type="text" id="end_date" autocomplete="off" name="end_date"
                            value="{{ old('end_date') }}" class="form-control flatpickr-datetime" />
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" id="member_price" autocomplete="off" name="member_price"
                            value="{{ old('member_price') }}" class="form-control numeral-mask" placeholder="Harga Member"
                            required />
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" id="non_member_price" autocomplete="off" name="non_member_price"
                            value="{{ old('non_member_price') }}" class="form-control numeral-mask"
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" id="normal_price" autocomplete="off" name="normal_price"
                            value="{{ old('normal_price') }}" class="form-control numeral-mask" placeholder="Harga Normal"
                            required />
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="description" autocomplete="off" name="description" class="form-control" rows="4"
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select id="status" autocomplete="off" name="status" class="form-select">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="file" id="thumbnail" autocomplete="off" name="thumbnail" class="form-control"
                            accept="image/*" />
                        <small class="text-muted">Maksimal ukuran file: 5MB</small>
                        <div class="preview mt-2">
                            <img id="thumbnailPreview" src="{{ asset('images/prmi-logo.webp') }}"
