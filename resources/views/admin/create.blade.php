                ...
                <form id="modalUserForm" class="row g-6" action="{{ route('admin.store') }}" method="POST">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" id="modalmodalUserFirstName" name="name" value="{{ old('name') }}"
                            class="form-control" placeholder="John" value="" />
                    </div>
                    <div class="col-12 col-md-6">
                        <label class="form-label" for="modalmodalUserEmail">Email</label>
                        <input type="text" id="modalmodalUserEmail" name="email" value="{{ old('email') }}"
                            class="form-control" placeholder="example@domain.com" value="" />
                    </div>
                    <div class="col-12 col-md-6">
                        <label class="form-label" for="modalmodalUserPhone">Phone Number</label>
                        <div class="input-group">
                            <span class="input-group-text">ID (+62)</span>
                            <input type="text" id="modalmodalUserPhone" name="phone" value="{{ old('phone') }}"
