    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="modalUserForm" class="row g-6" action="{{ route('blog.store') }}" method="POST"
    ...
    <script>
        $(document).ready(function() {
            ...
            tinymce.init({
                ...
                // ✅ Kunci konfigurasi URL agar tidak nambah "../"
                relative_urls: true,
                remove_script_host: true,
                document_base_url: '/', // ✅ Trik penting agar dia nganggap root dari sini
                convert_urls: false // ✅ Jangan ubah URL kita!
            });
